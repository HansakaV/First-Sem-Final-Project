...
public class FinancialRepo {
    ...
    public static Financial searchById(String id) throws SQLException {
    ...
    public static boolean update(Financial financial) throws SQLException {
    ...
    public static List<Financial> getAll() throws SQLException {
        ...
        List<Financial> financialsList = new ArrayList<>();
        ...
        while (resultSet.next()) {
            ...
            Financial f = new Financial(busId, description, income,cost);
